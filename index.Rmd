...
All those designated as _authors_ should meet one of the three criteria for authorship, 
and all who meet one of the three criteria should be identified as authors.
Those who do not meet one of these criteria due to the insubstantiality of their contribution
should rather be acknowledged as _contributors_ (see below).
...
Leem, Deborah, Turon, Gemma, Gruson, Hugo, Chue Hong, Neil, Kaur Bhogal, Saranjeet, Lo, Sherman, Druskat, Stephan, & Soiland-Reyes, Stian. (2023). SORTÆD: Software Role Taxonomy and Authorship Definition (0.1). Zenodo. https://doi.org/10.5281/zenodo.7896456.
